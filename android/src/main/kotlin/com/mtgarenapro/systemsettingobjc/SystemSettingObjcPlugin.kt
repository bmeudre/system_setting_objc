package com.mtgarenapro.systemsettingobjc
...
class SystemSettingObjcPlugin(
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "system_setting_objc")
            channel.setMethodCallHandler(SystemSettingObjcPlugin(registrar))
        }
    }
